...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel[] lbl = new JLabel[]{l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
    JLabel caption;
    
    public void run(){
        String[] text = new String[]{"JW Mariott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddison Blue Hotel","Classio Hotel","The Blay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
        try{
            for(int i = 0;i <=9; i++){
    ...
    CheckHotels(){
        ...
        for (int i=0 ; i<=9 ; i++){
            ...
            lbl[i] = new JLabel(kimage[i]);
            lbl[i].setBounds(0,0,800,600);
            add(lbl[i]);
        }
