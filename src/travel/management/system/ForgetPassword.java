...
public class ForgetPassword extends JFrame implements ActionListener {
    ...
    ForgetPassword(){
        ...
        lblquestion.setFont(new Font("TIMES_NEW_ROMAN",Font.PLAIN,15));
        p1.add(lblquestion);
        ...
        lblpassword.setBounds(40,200,150,25);
        lblpassword.setFont(new Font("TIMES_NEW_ROMAN",Font.BOLD,15));
        p1.add(lblpassword);
